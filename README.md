...
Check out the [Preview](https://dugu.vercel.app/).
...
Alternatively, you can also manually replace [Asset.jpeg](./resources/img/Asset.jpeg) with your image, make necessary changes at line 97 in [here](./scss/_components.scss) and then rebuild.
